  ...
  <div class="auto-group-k445-dpy">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
          <div style="font-size: 15px; margin: 0px 10%;">
              ...
              <label for="name_quiz">Đáp án đúng</label>
              <div style='margin: 20px 0 0 0;' class='input-group mb-3'>   
                  <input name='answer' type='text' class='form-control' placeholder='Nhập đáp án'value="<?php echo isset($_POST['answer'])?$_POST['answer']:"" ?>" readonly>
              </div>
              <?php 
                  }
              ?>  
                    ...
                    if(mysqli_num_rows($do)>0){
                        while($row=mysqli_fetch_array($do)) {   
                            if($row['id_question']==$_SESSION['view']){
                                ...
                                $_POST['answer']=$row['answer_correct'];
