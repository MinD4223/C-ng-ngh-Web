...
<head>
  ...
  <link rel="stylesheet" href="./styles/add_many_answer.css"/>
</head>
<body>
<div class="index">
    <?php
  ...
  <div class="auto-group-k445-dpy">
    ...
    <h1>DẠNG CÂU HỎI: Chọn nhiều đáp án</h1>
    ...
    <div style="font-size: 15px; margin: 0px 10%;" >
        ...
        <p>Nhập các lựa chọn và tích đáp án đúng</p>
                <?php
                    ...
                    for ($i = 1; $i <= $n; $i++) {
                        ...
                        // $value_text=echo isset($_POST["text".$i])? $_POST["text".$i]:"";
                        
                        echo '<div style="margin: 20px 0 0 0;" class="input-group mb-3">';
                        echo '<div class="input-group-text"><input type="checkbox" id="' . $i . '" name="' . $i . '" value="' . $i . '" ' . $isChecked . '></div>';
                        ?>
        ...
        <div style="margin: 20px 0 0 0;" class="d-grid">
            <input id="btn-add-question" class="btn btn-primary btn-block" name="add_question" type="submit" value="Thêm câu hỏi">
        </div>
    </div>
    </form>
    <?php 
       ...
       <?php 
            function add_del_answer(){
                ...
                if(isset($_POST['add_answer'])){
                    ...
                    echo '<script>
                            location.href = "add_many_answer.php?id_courses='.$id_courses.'";
                        </script>';
                }
                ...
                if(isset($_POST['add_question'])){
                    if($_POST["name_question"]!=""){
                        ...
                        for ($i = 1; $i <= $n; $i++) {
                            ...
                            if(isset($_POST[$i])){
                                //Nối chuỗi đáp án đúng với dấu / là dấu phân tách
                                if($text!=""){
                                    $temp_answer_correct=$temp_answer_correct."/".$text;
                                }else{
                                    $flag=false;
                                }
                            }
                        ...
                        if($flag==true){
                            ...
                            if($flag1==true){
                                ...
                                if($temp_answer_correct!=""){
                                    ...
                                    $type_question="Câu hỏi nhiều đáp án";
                                    $answer=$temp_answer;
